...
/// <h2>Important</h2>
/// This method should <em>only</em> be called when there is a currently running animation.
/// That is, after a call to <code>startProgress</code>.
/// <h2>Author</h2>
/// Luis Padron
- (void)pauseProgress;
/// Continues the animation with it’s remaining time from where it left off before it was paused.
/// <h2>Important</h2>
/// This method should <em>only</em> be called when there is a currently paused animation.
/// That is, only call this method after you have called <code>pauseProgress</code>.
/// <h2>Author</h2>
/// Luis Padron
